...
publisher_gross_share - (publisher_gross_share * pg_percentage_amount) - pg_fixed_amount end as publisher_gross_share_after_pg
...
from (
    ...
    ,core_orderlines.adjusted_currency_code as adjusted_currency_code
    ,core_orderlines.adjusted_price as adjusted_price
    ,core_orderlines.adjusted_final_price as adjusted_final_price
    ...
    core_paymentgatewayformulas.card_type,
    core_revenuesformulas.fixed_amount, core_revenuesformulas.percentage_amount,
    core_paymentgatewayformulas.paymentgateway_id
    --             core_matrixtiers.USD, core_matrixtiers.IDR
...
,core_orderlines.adjusted_currency_code as currency_code -- INI SEBENERNYA ADJUSTED CURRENCY CODE HANYA PENAMAAN NYA PRICE SAJA

,core_orderlines.adjusted_price as price -- INI SEBENERNYA ADJUSTED PRICE HANYA PENAMAAN NYA PRICE SAJA
...
and core_orderlines.price = core_matrixtiers.tier_price
    ...
    core_orderlines.adjusted_price, core_orderlines.adjusted_currency_code,
    core_payments.paymentgateway_id,
    localized_currency_code,
    core_matrixtiers.matrix_usd,core_matrixtiers.matrix_idr
